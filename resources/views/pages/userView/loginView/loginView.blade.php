...
<head>
  ...
  <meta name="csrf-token" content="2rSCJFeViaeWSl4PGs3bD3GrGCAQ7aYxqI28yVQZ">
  ...
  <div class="auth-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
      <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                  <img class="img-fluid" src="http://127.0.0.1:8000/images/pages/login-v2.svg" alt="Login V2" />
                </div>
    </div>
    <!-- /Left Text-->
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        ...
        <form class="auth-login-form mt-2" action="/" method="GET">
          ...
          <div class="mb-1">
            <div class="d-flex justify-content-between">
              ...
              <a href="http://127.0.0.1:8000/auth/forgot-password-cover">
        ...
        <p class="text-center mt-2">
          ...
          <a href="http://127.0.0.1:8000/auth/register-cover"><span>&nbsp;Create an account</span></a>
        </p>
...
<!-- END: Theme JS-->
<!-- BEGIN: Page JS-->
<script src="http://127.0.0.1:8000/js/scripts/pages/auth-login.js"></script>
<!-- END: Page JS-->
