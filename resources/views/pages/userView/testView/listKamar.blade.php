    ...
    <div class="col-12">
      <div class="card">
        ...
        <?php $n=1 ?>
            ...
            <div class="card ">
              <div class="card-body">
                <span class="badge bg-info m-auto">Occupied</span
                <div class="d-flex justify-between">
                  <p>Nomor Kamar{{$n++}}</p>
                  <h2>{{$data->namaKamar}}</h2>
                </div>
                <h2>Specification :</h2>
                <p>Type Kamar : {{$data->typeKamar}}</p>
                <p>Fasilitas Kamar : {{$data->fasilitasKamar}}</p>
                <p>Interior Tambahan Kamar : {{$data->interiorKamar}}</p>
              </div>
            </div>
            @endforeach
      </div>
