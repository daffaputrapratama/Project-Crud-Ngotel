...
<head>
  ...
  <meta name="csrf-token" content="1kPJgCfZTpqPBiGGBxh4UROjlRhA5OLcUbX3TxQo">
  ...
  <div class="auth-inner row m-0">
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        ...
        <h1 class="card-title fw-bolder mb-1">Your Registration is Success!✅</h1>
      
       
        <p class="card-text mb-2">This the Time to Join With Us!<a href="/" class="fw-bolder">Click Here to Login</a> Please follow the link inside to continue.</p>
        <a class="btn btn-primary w-100" href="/">Login Now</a>
        </p>
      </div>
    </div>
    <!-- verify email cover-->
